...
locals {
  ...
  notification_service_plan_name         = "${local.identity}notsp${local.short_location}"
  notification_fapp_storage_account_name = "${local.identity}notsa${local.short_location}"
  notification_fapp_name                 = "${local.identity}notfapp${local.short_location}"
}